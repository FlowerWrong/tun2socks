...
func TestIPCIDRPattern(t *testing.T) {
	...
	cases := map[interface{}]bool{
		util.ConvertIPv4ToUint32(net.ParseIP("192.167.255.255")): false,
		util.ConvertIPv4ToUint32(net.ParseIP("192.168.0.0")):     true,
		util.ConvertIPv4ToUint32(net.ParseIP("192.168.255.255")): true,
		util.ConvertIPv4ToUint32(net.ParseIP("10.17.0.0")):       false,
		util.ConvertIPv4ToUint32(net.ParseIP("10.18.0.0")):       true,
		util.ConvertIPv4ToUint32(net.ParseIP("10.18.0.255")):     true,
