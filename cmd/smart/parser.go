...
func main() {
	...
	writeAndCheck(out, "welcome_info Happy New Year!")
	writeAndCheck(out, "global_mode false")
	writeAndCheck(out, "firewall_mode true")
	writeAndCheck(out, "debug true")
	writeAndCheck(out, "")

	writeAndCheck(out, "ip 172.25.0.1")
	writeAndCheck(out, "dns 223.5.5.5")
	writeAndCheck(out, "dns 119.29.29.29")
